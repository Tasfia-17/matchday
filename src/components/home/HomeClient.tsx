    ...
    >
      ...
      {isMobile !== true && (
        <footer className={`hidden sm:block relative p-6 pb-24 text-center text-sm transition-all duration-700 delay-300 ${isLoaded ? 'opacity-100' : 'opacity-0'}`}>
          ...
          <p className="opacity-90 text-xs">© {new Date().getFullYear()} MatchDay. {t('allRightsReserved')}</p>
            ...
            <Dock
              items={[
                ...
                },
                {
                  ...
                  label: "Support MatchDay & keep the vibes cozy! :3",
                  onClick: () => window.open('https://buymeacoffee.com/matchday', '_blank'),
