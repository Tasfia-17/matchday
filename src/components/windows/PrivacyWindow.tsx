      ...
      <div className="space-y-5">
        ...
        <section>
          ...
          <p className="opacity-80 leading-relaxed">
            At MatchDay, we take your privacy seriously. This policy explains how we collect, use, and protect your information.
          </p>
        </section>
        ...
        <div className="pt-3 border-t border-black/10 dark:border-white/10">
          ...
          <p className="opacity-80 text-xs leading-relaxed">
            By using MatchDay, you agree to use the platform responsibly, respect other users, and not share 
