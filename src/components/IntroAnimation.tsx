...
export default function IntroAnimation({ onComplete }: IntroAnimationProps) {
    ...
    useEffect(() => {
        const alreadySeen = !!sessionStorage.getItem('matchday_intro_played');
        ...
        if (!alreadySeen) {
            ...
            const timer = setTimeout(() => {
                setShow(false);
                sessionStorage.setItem('matchday_intro_played', 'true');
                onComplete?.();
            }, 3000);
                    ...
                    >
                        <div className="relative z-10 flex flex-col items-center text-center">
                            ...
                            <m.div className="overflow-hidden">
                                ...
                                >
                                    Welcome to <span style={{ color: currentTheme.colors.primary }}>MatchDay</span>.
                                </m.h1>
                            </m.div>
