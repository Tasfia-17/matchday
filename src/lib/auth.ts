...
declare global {
  ...
  var __matchday_auth_cleanup_interval_set: boolean | undefined;
}
...
if (typeof setInterval !== 'undefined' && !globalThis.__matchday_auth_cleanup_interval_set) {
  setInterval(() => {
    const now = Date.now();
  ...
  globalThis.__matchday_auth_cleanup_interval_set = true;
}
