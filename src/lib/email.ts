...
// sender (e.g. "MatchDay <noreply@yourdomain.com>") to send to any address.
const FROM_EMAIL = process.env.RESEND_FROM_EMAIL || 'MatchDay <onboarding@resend.dev>';
const APP_NAME = 'MatchDay';
