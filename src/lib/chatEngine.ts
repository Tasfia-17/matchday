// MatchDay AI Chat Engine — Smart rule-based response system
// Deep knowledge of MatchDay features with contextual awareness
...
const INTENTS: Intent[] = [
    // Greeting
    {
        ...
        responses: [
            "Hey there, friend! 🐱✨ Welcome to MatchDay — your cozy corner for watching together. What can I help you with today?",
            "Heya! 🎬 Your MatchDay AI concierge is here and ready to help. What's on your mind?",
            "Hello hello! 🐾 Ready to make your MatchDay experience purrfect. Ask me anything!",
            "Yo! 👋 MatchDay's AI assistant at your service. Need help with rooms, friends, games, or anything else?",
        ],
    ...
    // Crates / Rewards
    {
        ...
        responses: [
            "Crates are surprise reward boxes! 🎁\n\nEarn crates through various activities on MatchDay. Open them to get random rewards! Check the **Crates** icon (🎁) in your dock to see what you've collected.",
        ],
    ...
    // Goodbye
    {
        ...
        responses: [
            "See ya, friend! 🐾 Enjoy your time on MatchDay. Come back anytime you need help! 🎬✨",
    ...
    // Easter Eggs
    {
        ...
        responses: [
            "Ooh, looking for secrets? 👀🐱\n\nI can neither confirm nor deny that MatchDay has hidden surprises. But I *will* say… try clicking the logo a few times on the homepage. And maybe try a certain famous code sequence? ⬆️⬆️⬇️⬇️⬅️➡️⬅️➡️🅱️🅰️\n\nThat's all I'm saying! 🤫✨",
        ],
        suggestions: ['What are badges?', 'Tell me about party mode', 'What features does MatchDay have?'],
    },
...
const FALLBACK_RESPONSES = [
    "Hmm, I'm not quite sure about that one! 🤔 But I know a LOT about MatchDay — try asking me about rooms, XP, themes, friends, or any of our features!",
    "That's outside my area of expertise, but I'm a MatchDay whiz! 🐱 Ask me about creating rooms, daily quests, leaderboards, or anything else on the platform!",
    ...
    "Not sure I can help with that specifically, but I know MatchDay inside and out! 🐾 What would you like to know about our features?",
];
