// Pokemon facts for MatchDay - Fun Pokemon trivia
...
export const POKEMON_FACTS_EN = [
  ...
  { fact: "Pikachu was originally going to be MatchDay's mascot from day one!", pokemon: "Pikachu", avatar: pokemonSprite(25) },
...
export const POKEMON_FACTS_TR = [
  ...
  { fact: "Pikachu en başından beri MatchDay'un maskotu olacaktı!", pokemon: "Pikachu", avatar: pokemonSprite(25) },
