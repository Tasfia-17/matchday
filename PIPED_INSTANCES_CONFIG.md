...
The MatchDay music player streams audio via [Piped](https://github.com/TeamPiped/Piped), a privacy-preserving YouTube frontend. Because Piped instances can go offline or become slow, the player supports dynamic instance configuration with automatic failover.
