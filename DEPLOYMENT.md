# MatchDay Deployment Guide

MatchDay runs as two independent processes — the **Next.js app** and the **Socket.io server** — plus a PostgreSQL database and an optional Redis instance.
...
# PostgreSQL
DATABASE_URL=postgresql://user:password@host:5432/matchday
...
3. **Select MatchDay**: Choose your repository
4. **Add Services**:
...
2. Click "Add New Project" → Import your MatchDay repo
3. Configure:
...
1. Click "+ New" → "GitHub Repo" → Select MatchDay
2. **Settings**:
...
- `NEXTAUTH_URL` - Your frontend URL (e.g., `https://matchday.vercel.app`)
