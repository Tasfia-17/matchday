...
MatchDay is a synchronized video watching platform with real-time chat, gamification features, and social networking capabilities. This document describes the actual technology stack, infrastructure, and implementation details based on the current codebase.
...
### Network
- All services communicate via `matchday_net` bridge network
...
NEXTAUTH_URL="https://matchday.me"

# Email
RESEND_API_KEY="re_..."
RESEND_FROM_EMAIL="MatchDay <noreply@matchday.me>"
```
...
NEXT_PUBLIC_SITE_URL=https://matchday.me
NEXT_PUBLIC_SOCKET_URL=https://matchday.me
```
