/**
 * MatchDay — Server Entry Point (Orchestrator)
 *
 * Thin orchestrator for the real-time server. Owns ONLY infrastructure:
 ...
 *   • Graceful shutdown
 *
 * Domain logic lives in handlers/:
 *   handlers/roomHandler.ts      — Match room lifecycle + queue
 *   handlers/chatHandler.ts      — Live chat + Write-Behind caching
 *   handlers/videoHandler.ts     — Video sync + Soft Correction
 *   handlers/gameHandler.ts      — Sports trivia + mini-games
